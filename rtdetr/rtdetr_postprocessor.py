...
# set numpy and torch suppress scientific notation
...
class RTDETRPostProcessor(nn.Module):
    ...
    def forward(
        ...
        results = []
        for lab, box, sco, sel_cls in zip(labels, boxes, scores, selected_classes):
            # if sel_cls is not None:
            #     lab[lab == 1] = sel_cls.long()
